...
/**
 * SellOrder is a type of order that gains hitcoins to the trader which created it when it reaches it target.
 */
public class SellOrder extends Order {
   ...
   */
  public SellOrder(Trader t, Vec2 pos, Vec2 target, double s, int amount) {
    super(t, pos, target, s, amount);
  }

  /**
   * Draws the SellOrder as a Pink ball with amount written on the inside. The initials of the trader is written above the order.
